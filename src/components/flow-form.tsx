      ...
      <Tabs value={formTab} onValueChange={onFormTabChange}>
        ...
        <TabsContent value="basic" className="mt-6 space-y-4">
          <div className="space-y-2">
            ...
            <Input
              id="flowName"
              placeholder="日次 Excel CSV エクスポート"
        ...
        <TabsContent value="source" className="mt-6 space-y-4">
          ...
          {values.dataSourceType === "box" ? (
            <div className="space-y-2">
              <Label htmlFor="sourceBoxFolderId">Box フォルダ ID</Label>
              <Input
            ...
            <>
              <div className="space-y-2">
                <Label htmlFor="sourceSharePointSiteUrl">サイト URL</Label>
                <Input
        ...
        <TabsContent value="output" className="mt-6 space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="destinationBoxFolderId">出力先 Box フォルダ ID</Label>
            <Input
